...
lime.Video.prototype.makeVideoElement_ = function () {
    ...
    if (!this.videoElement_) {
        ...
        //this.rootElement.appendChild(this._videoElement);
...
console.log('video render called');
    ...
    if (this.videoElement_ && context) {
        context.drawImage(this.videoElement_, 0, 0, this.size_.width, this.size_.height);
    }
